...
public class FlowableServiceTask01Test {
    //从spring容器中获取流程引擎
    @Autowired
    ...
    public void deployFlow() {
        Deployment deploy = processEngine.getRepositoryService().createDeployment()
                // 部署一个流程
                .addClasspathResource("process/02-task/task-service-task.bpmn20.xml")
                .name("服务任务")
                .deploy();
    ...
    public void startProcess() {
        ...
        String processInstanceId = "task-service-task:1:51673496-911a-11ef-a1c5-287fcff7031e";
