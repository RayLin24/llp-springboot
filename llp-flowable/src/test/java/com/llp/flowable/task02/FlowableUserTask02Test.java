...
public class FlowableUserTask02Test {
    //从spring容器中获取流程引擎
    @Autowired
    ...
    public void deployFlow() {
        Deployment deploy = processEngine.getRepositoryService().createDeployment()
                // 部署一个流程
                .addClasspathResource("process/02-task/task-user-task02.bpmn20.xml")
                .name("用户任务委派转办")
                .deploy();
    ...
    public void startProcess() {
        ...
        map.put("INITATOR", "llp");
        // 一、流程实例id启动流程实例
        String processInstanceId = "task-user-task02:1:b9f8864c-9109-11ef-9bcc-287fcff7031e";
