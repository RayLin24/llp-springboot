...
public class GeneratorTools {
    public static void main(String[] args) {
        ...
        DataSourceConfig dataSourceConfig = new DataSourceConfig
                .Builder("jdbc:mysql://localhost:3306/mybatisplus?autoReconnect=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8&allowMultiQueries=true",
                "root",
                "root")
                .dbQuery(mySqlQuery).
                build();
         ...
         * 全局配置
         */
        String projectPath = System.getProperty("user.dir")+"/llp-mybatisplus"; //获取项目路径
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.llp.mybatisplus")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
